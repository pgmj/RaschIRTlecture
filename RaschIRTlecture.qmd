...
-   You now know that these methods and tools exist and where to find them
    -   A sample Rasch analysis with code and data: [easyRasch vignette](https://pgmj.github.io/raschrvignette/RaschRvign.html)
...
::: {.column width="50%"}
```{r}
data.frame(Criterion = psychometric_criteria[,1]) %>% 
  kable()
```
